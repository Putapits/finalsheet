...
// Verify user role is 'health_worker'
...
<main class="flex-1">
    ...
    switch ($page) {
                        ...
                        <div class="flex flex-col md:flex-row items-center justify-between gap-8">
                            <div class="text-white space-y-4 max-w-2xl">
                                ...
                                <h1 class="text-4xl md:text-5xl font-extrabold tracking-tight">
                                    Hello, Health Worker <?php echo htmlspecialchars($user['first_name']); ?>!
                                </h1>
                                <p class="text-lg text-white/80">
                                    Manage health surveillance reports, track cases, and access vital health services.
                                </p>
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-20">
                    <div class="dashboard-grid">
                        ...
                        <div class="glass-card stat-card rounded-3xl p-8 shadow-xl">
                            <div class="flex items-center gap-4 mb-4">
                                ...
                                <h3 class="text-lg font-bold text-gray-900 dark:text-white">Staff Credentials</h3>
                            </div>
                            <div class="flex items-center gap-2">
                                <span
                                    class="px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider bg-indigo-100 text-indigo-800">
                                    <?php echo str_replace('_', ' ', ucfirst($_SESSION['role'] ?? 'Staff')); ?>
                                </span>
                                <span
                    ...
                    <div class="mt-12 py-12">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
                            <?php
                            $quicklinks = [
                                ['Health Surveillance', '../health_surveillance.php', 'bg-indigo-50 text-indigo-600', 'H', 'border-indigo-200', 'shadow-indigo-500/10', 'indigo'],
                                ['Health Center', '../health_center_services.php', 'bg-rose-50 text-rose-600', 'H', 'border-rose-200', 'shadow-rose-500/10', 'rose'],
                                ['Immunization', '../immunization_tracker.php', 'bg-purple-50 text-purple-600', 'I', 'border-purple-200', 'shadow-purple-500/10', 'purple']
                            ];
        ...
        case 'services':
            ...
            echo '<option value="surveillance" class="dark:bg-gray-800">🔍 Health Surveillance System</option>';
            echo '</select>';
            echo '</div>';
            echo '</div>';
            echo '</div>';
            ...
            $content = str_replace(
                [
                    ...
                    'href="citizen.php?page=services#surveillance"'
                ],
                [
